...
export const init = (componentLists: any, layoutConfig: any, data: any) => {
  ...
  const sectionNames: string[] =
    check_length_of_object_return_its_keys_of_content_in_array(
      layoutConfig.layout
    );
...
export const layoutFinderByTemplateIdentifier = (
  layoutConfigs: any[],
  templateIdentifier: string
) => {
  // console.log(
  //   "vallue in  layoutfindbyrmepide is",
  //   layoutConfigs,
  //   templateIdentifier
  // );
  return layoutConfigs.filter(
    (layout) => layout.templateIdentifier === templateIdentifier
  )[0];
};
